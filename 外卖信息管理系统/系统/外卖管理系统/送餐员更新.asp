...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE dbo.staff SET s_id = ?, s_name = ?, s_tele = ?, passwords = ? WHERE s_id = ?" 
    ...
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param3", 201, 1, 20, Request.Form("textfield3")) ' adLongVarChar
...
Recordset1_cmd.CommandText = "SELECT * FROM dbo.staff WHERE s_id = ?" 
...
<form id="form1" name="form1" method="POST" action="<%=MM_editAction%>">
  <p align="center">员工号：
    ...
    <input name="textfield" type="text" id="textfield" value="<%=(Recordset1.Fields.Item("s_id").Value)%>" />
  </p>
  <p align="center">员工名：
    <label for="textfield2"></label>
    <input name="textfield2" type="text" id="textfield2" value="<%=(Recordset1.Fields.Item("s_name").Value)%>" />
  </p>
  <p align="center">员工电话： 
    <label for="textfield3"></label>
    <input name="textfield3" type="text" id="textfield3" value="<%=(Recordset1.Fields.Item("s_tele").Value)%>" />
  </p>
  <p align="center">密码：
    <label for="textfield4"></label>
    <input name="textfield4" type="text" id="textfield4" value="<%=(Recordset1.Fields.Item("passwords").Value)%>" />
  </p>
  <p align="center">
    <input type="submit" name="button" id="button" value="修改" />
  <a href="送餐员.asp">退出修改</a></p>
  <div align="center">
    <input type="hidden" name="MM_update" value="form1" />
    <input type="hidden" name="MM_recordId" value="<%= Recordset1.Fields.Item("s_id").Value %>" />
  </div>
</form>
</body>
</html>
