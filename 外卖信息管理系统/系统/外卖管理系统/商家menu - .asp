...
%>
  <tr>
    ...
    <td><%=(Recordset1.Fields.Item("u_id").Value)%></td>
    <td><a href="商家menu更新.asp?xgid<%=(Recordset1.Fields.Item("m_id").Value)%>">编辑</a></td>
  </tr>
  <% 
...
<form id="word" name="form1" method="post" action="搜索菜.asp">
