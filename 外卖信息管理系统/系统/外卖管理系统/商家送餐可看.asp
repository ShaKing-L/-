...
Recordset1_cmd.CommandText = "SELECT * FROM dbo.o_c_s_d_s_m" 
...
<body>
<table width="1408" border="1" align="center">
  <tr align="center">
    <td width="149">员工号</td>
    <td width="174">员工名</td>
    <td width="151">订单号</td>
    ...
    <td width="173">数量</td>
    <td width="175">客户名</td>
    <td width="195">客户地址</td>
    <td width="159">客户电话</td>
  </tr>
  <% 
...
<form id="form1" name="form1" method="post" action="搜索订单.asp">
  ...
  <div align="center" id="word"> 搜索（输入员工号）：
    <input type="text" name="word" id="word" />
    <input type="submit" name="word2" id="word" value="提交" />
</div></form>
