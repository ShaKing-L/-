...
<table width="608" border="1" align="center">
  <tr>
    <td width="149">送餐员号</td>
    <td width="174">送餐员名</td>
    <td width="162">送餐员电话</td>
    <td width="95">修改</td>
  </tr>
  <% 
...
%>
  <tr>
    ...
    <td><a href="送餐员更新.asp?xgid=<%=(Recordset1.Fields.Item("s_id").Value)%>">编辑</a></td>
    </tr>
  <% 
