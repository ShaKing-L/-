...
%>
  <tr>
    <td><%=(Recordset1.Fields.Item("c_id").Value)%></td>
...
<table width="229" border="0" align="center">
  <tr>
    <td width="35"><a href="<%=MM_movePrev%>">首页</a></td>
    <td width="50"><a href="<%=MM_movePrev%>">前一页</a></td>
    <td width="50"><a href="<%=MM_moveNext%>">下一页</a></td>
    <td width="76"><a href="<%=MM_moveLast%>">末页</a></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
